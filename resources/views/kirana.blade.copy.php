...
<head>
    ...
    <meta name="description"
        content="にじさんじ所属VTuberユニット『{{ $site_title }}』（風楽奏斗/渡会雲雀/四季凪アキラ/セラフ・ダズルガーデン）No.1ダンスボーカルユニットを目指して活動中！">
    <meta property="og:title" content="KIRANA">
    ...
    <meta name="twitter:title" content="KIRANA">
...
<body class="top" data-pagestart="1" data-intro="1" data-theme="water">
    ...
    <script>
        self.__next_f.push([1,
            "e:[[\"$\",\"meta\",\"0\",{\"name\":\"viewport\",\"content\":\"width=device-width, initial-scale=1\"}],[\"$\",\"meta\",\"1\",{\"charSet\":\"utf-8\"}],[\"$\",\"title\",\"2\",{\"children\":\"{{ $site_title }}\"}],[\"$\",\"meta\",\"3\",{\"name\":\"description\",\"content\":\"にじさんじ所属VTuberユニット『{{ $site_title }}』（風楽奏斗/渡会雲雀/四季凪アキラ/セラフ・ダズルガーデン）No.1ダンスボーカルユニットを目指して活動中！\"}],[\"$\",\"meta\",\"4\",{\"property\":\"og:title\",\"content\":\"{{ $site_title }}\"}],[\"$\",\"meta\",\"5\",{\"property\":\"og:description\",\"content\":\"にじさんじ所属VTuberユニット『{{ $site_title }}』（風楽奏斗/渡会雲雀/四季凪アキラ/セラフ・ダズルガーデン）No.1ダンスボーカルユニットを目指して活動中！\"}],[\"$\",\"meta\",\"6\",{\"property\":\"og:url\",\"content\":\"https://www.voltaction-official.com/\"}],[\"$\",\"meta\",\"7\",{\"property\":\"og:site_name\",\"content\":\"{{ $site_title }}\"}],[\"$\",\"meta\",\"8\",{\"property\":\"og:image\",\"content\":\"https://www.voltaction-official.com/assets/ogp.jpg\"}],[\"$\",\"meta\",\"9\",{\"property\":\"og:type\",\"content\":\"website\"}],[\"$\",\"meta\",\"10\",{\"name\":\"twitter:card\",\"content\":\"summary_large_image\"}],[\"$\",\"meta\",\"11\",{\"name\":\"twitter:title\",\"content\":\"{{ $site_title }}\"}],[\"$\",\"meta\",\"12\",{\"name\":\"twitter:description\",\"content\":\"にじさんじ所属VTuberユニット『{{ $site_title }}』（風楽奏斗/渡会雲雀/四季凪アキラ/セラフ・ダズルガーデン）No.1ダンスボーカルユニットを目指して活動中！\"}],[\"$\",\"meta\",\"13\",{\"name\":\"twitter:image\",\"content\":\"https://www.voltaction-official.com/assets/ogp.jpg\"}],[\"$\",\"link\",\"14\",{\"rel\":\"icon\",\"href\":\"/assets/favicon.ico\"}],[\"$\",\"link\",\"15\",{\"rel\":\"apple-touch-icon\",\"href\":\"/assets/apple-icon.png\"}],[\"$\",\"meta\",\"16\",{\"name\":\"next-size-adjust\"}]]\n7:null\n"
        ])
    </script>
    <script>
        self.__next_f.push([1,
